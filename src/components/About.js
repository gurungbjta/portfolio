            ...
            <section className="container-fluid px-5 pt-2">
                <div className="row ml-5 mt-3 ">
                    <div className="col-md-6 text-center order-2 order-md-1" style={{height: '300px', width:'400px', lineHeight: '28px'}}>
                        <p>
                            After moving to the Bay Area six years ago from Nepal, my fondness for tech grew even more profound. 
                    ...
                    <div className="col-md-6 order-1 order-md-2">
                        <img src={girl3} alt="girl3" style={{height: '250px', width: '270px'}} />
                ...
                <div className="row ml-0 mr-5 pr-5 mt-3">
                    <div className="col-md-6 text-center">
                        <img src={pinkComp} alt="pinkComputer" style={{height: '250px', width: '280px'}} />
